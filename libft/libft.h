...
# define CHK_CI(a) if (a == NULL) return (-1);
# define CHK_CV(a) if (a == NULL) return ;
# define CHK_CC(a) if (a == NULL) return (NULL);
# define CHK_II(a) if (a < 0) return (-1);
# define CHK_IV(a) if (a < 0) return ;
# define CHK_IC(a) if (a < 0) return (NULL);
# define BUFF_SIZE 42
